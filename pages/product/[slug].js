         ...
         <Wrapper>
            <div className="flex flex-col lg:flex-row md:px-10 gap-[50px] lg:gap-[100px]">
               ...
               <div className="flex-[1] py-3">
                  {/* PRODUCT TITLE */}
                  <div className="text-[34px] font-semibold mb-2 leading-tight">Product Title</div>

                  {/* PRODUCT SUBTITLE */}
                  <div className="text-lg font-semibold mb-5">Lorem lorem lorem</div>

                  {/* PRODUCT PRICE */}
                  <div className="flex items-center">
                     <p className="mr-2 text-lg font-semibold">MRP : &#8377; 10000</p>
                     <p className="text-base  font-medium line-through">&#8377; 100000</p>
                     <p className="ml-auto text-base font-medium text-green-500">90% off</p>
                  </div>
