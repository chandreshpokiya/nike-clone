      ...
      <div className="w-full md:py-20">
         <Wrapper>
               ...
               <div className="flex-[1]">
                  ...
                  <div className="p-5 my-5 bg-black/[0.05] rounded-xl">
                     <div className="flex justify-between">
                        ...
                        <div className="text-md md:text-lg font-medium text-black">&#8377; 999999</div>
                     </div>
                     <div className="text-sm md:text-md py-5 border-t mt-5">The subtotal reflects the total price of your order, including duties and taxes, before any applicable discounts. It does not include delivery costs and international transaction fees.</div>
                  </div>
            ...
            {/* <div className="flex-[2] flex flex-col items-center pb-[50px] md:-mt-14">
               <Image src="/empty-cart.jpg" alt="empty-icon" width={300} height={300} className="w-[300px] md:w-[400px]" />
