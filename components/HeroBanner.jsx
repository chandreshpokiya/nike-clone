      ...
      <div className="relative text-white text-xl w-full max-w-[1360px] mx-auto">
         ...
         >
            <div>
               ...
               <img src="/slide-1.png" />
               <div className="px-[15px] md:px-10 py-[10px] md:py-[25px] font-oswald bg-white absolute bottom-[25px] md:bottom-[75px] left-0 text-black/[0.9] text-[15px] md:text-[30px] uppercase font-medium cursor-pointer hover:opacity-90">Shop now</div>
            </div>
            <div>
               {/* eslint-disable-next-line */}
               <img src="/slide-2.png" />
